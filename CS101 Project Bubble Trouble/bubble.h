...
public:
    ...
    void nextStep(double t)
    {
        ...
        double new_y = circle.getY() + u*t + 5*t*t;      //under gravity
        vy+=(10*t);
        ...
        if ((vy > 0 && new_y > (450. - circle.getRadius())))     //bounces along y direction at bottom line

        {

            vy = -vy;
            u  =  vy;
            new_y = circle.getY() + u*t + 5*t*t;
